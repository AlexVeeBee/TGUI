        ...
        content = function(window, dt_w)
            ...
            uic_container( UiWidth()-24, UiHeight()-148 , true, true, false, function(window)
                ...
                UiPush()
                    ...
                    buttonIcon(tgui_ui_assets..'/textures/arrow_left.png', true, function()
                    ...
                    UiTranslate(24,0)
                    buttonIcon(tgui_ui_assets..'/textures/arrow_right.png', true, function() end)
                    UiTranslate(24,0)
                ...
                uic_container( UiWidth()-12, UiHeight()-36 , true, false, false, function()
                    UiImageBox(tgui_ui_assets..'/textures/outline_inner_normal_dropdown.png',UiWidth(), UiHeight(),1,1)
                    if #listKeys == 0 then
                        ...
                        function dump_reg()
                                table.insert(ALL_WINDOWS_OPEN ,{
                                    ...
                                    content = function(warningWindow)
                                        UiTranslate(12,0)
                                        UiPush()
                                            uic_text("WARNING: you are about to dump a registry. Are you sure?", 24)
                                            UiTranslate(0,24)
            ...
            UiPush()
                ...
                UiAlign('top right')
                uic_button_func{dt = dt_w,text = "Open path", width = 100, height = 24, onclick = function()
                    window.focused = false
                    table.insert(ALL_WINDOWS_OPEN ,{
                        testFirstFrame = true,
                        firstFrame = true,
                        ...
                        content = function(openPathWindow)
                            UiPush()
                                ...
                                for i,v in ipairs(registries) do
                                    uic_button_func{dt = dt_w, text = v, width = 150 - 24, height = 24, onclick = function()
                                        window.StringViewer.path = v
                                        table.insert(window.StringViewer.history ,{
                                            path = v,
                                            viewing = true,
                                        })
                            ...
                            UiPush()
                                ...
                                uic_button_func{dt = dt_w,text = "Open", width =60, height = 24, disabled = disableButton, onclick = function()
                ...
                UiTranslate(-110,0)
                uic_button_func{dt = dt_w,text = "Help", width = 100, height = 24, onclick = function()
                    window.focused = false
                    table.insert(ALL_WINDOWS_OPEN ,{
                        testFirstFrame = true,
                        firstFrame = true,
